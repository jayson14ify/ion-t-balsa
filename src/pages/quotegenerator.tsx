  ...
  return (
    <IonPage>
      ...
      <IonContent className='ion-padding'>
        ...
        <img alt="Silhouette of mountains" src="https://media.tenor.com/i7Q_UmHcEFkAAAAe/jose-rizal-meme-jose-rizal-dimples.png" />
          {/*Button Trigger*/}
          <IonGrid>
            <IonRow>
                <IonCol size="" push="">
                <IonButton id="present-alert" color="tertiary" shape="round" expand="block" onClick={handleOpenAlert}>Click me</IonButton> 
                <IonAlert
                  isOpen={showAlert}
